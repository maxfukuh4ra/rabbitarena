...
// since the History class does not have a default constructor but only a constructor with 2 parameters to initialize that with the Arena constructor
...
// should be called when a rabbit starts its turned poisoned but alive (rabbit's move function)
